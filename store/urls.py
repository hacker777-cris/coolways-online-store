...
from store.views import payment_success_view,order_success_view, category_view,home_view,signup_view,checkout_view,login_view,products_view,profile,addProduct,logoutuser,cart,add_to_cart,singleproduct_view
